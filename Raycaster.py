...
wallTextures = {
    # Textura 1
    '1': pygame.image.load('Sources/1.png'),
    # Textura 2
    '2': pygame.image.load('Sources/2.png'),
    # Textura 2
    '3': pygame.image.load('Sources/3.png'),
    # Textura 2
    '4': pygame.image.load('Sources/4.png'),
    }

# Como aclaracion, todas las texturas parte de la 1, pero es solo para que se vea bonito. 
